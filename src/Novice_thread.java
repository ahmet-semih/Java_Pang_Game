...
public class Novice_thread  extends JPanel{
    ...
    public Novice_thread(String username) {
    ...
    public void finish_game_succesful() {
    	...
    	int finalscore = userscore + userlife*10 + timeLeft*5;
    ...
    public void record_user_score_to_csv() {
	     ...
	     try (FileWriter write_user_score = new FileWriter("Users/" + username + ".csv", true)) {
    	        write_user_score.write(formattedDate + "," + (100 - timeLeft) + "," + "Novice" + "," + finalscore + "\n");
    	 } catch(Exception e) {
    	...
    	gameThread = new Thread(() -> {
    		while (gameThreadRunning) {
                ...
                for (Balloon b : current_baloons) {
                    ...
                    Rectangle charRect = new Rectangle(characterX, characterY, 65, 65);
